...
<form class="form-horizontal" id="default-form" method="POST" action="<?=site_url('process/device_new')?>">
<div class="modal-dialog">
<div class="modal-content">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    <h4 class="modal-title"><i class="fa fa-file"></i> Formulir Alat Baru</h4>
  </div>
  ...
  <div class="row">
	      ...
	      <div class="form-group">
		    ...
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="part_name" required name="part_name" placeholder="Part Name ...">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="drawing_maker" name="drawing_maker" placeholder="Drawing Maker...">
		    </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="d_upper" name="d_upper" placeholder="Diameter Upper...">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="d_lower" class="col-sm-5 control-label">Diameter Lower</label>
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="d_lower" name="d_lower" placeholder="Diameter Lower...">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="depth" class="col-sm-5 control-label">Depth / Height (DH)</label>
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="depth" name="depth" placeholder="Depth / Height...">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="depth_upper" class="col-sm-5 control-label">DH Upper</label>
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="depth_upper" name="depth_upper" placeholder="DH Upper...">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="depth_lower" class="col-sm-5 control-label">DH Lower</label>
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="depth_lower" name="depth_lower" placeholder="DH Lower...">
		    </div>
		  </div>
		...
		<div class="col-md-6">
		  <div class="form-group">
		    ...
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="drawing_ahm" name="drawing_ahm" placeholder="Drawing AHM...">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="material_number" class="col-sm-5 control-label">Material Number</label>
		    <div class="col-sm-7">
		      <input type="text" class="form-control" id="material_number" name="material_number" placeholder="Material Number...">
		    </div>
		  </div>
		  <div class="form-group">
